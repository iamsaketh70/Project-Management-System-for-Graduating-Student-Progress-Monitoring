<div class="page-hdr" style="background: linear-gradient(to right,#0acffe 0,#495aff 100%);">
        ...
        <div class="col-8 col-md-5 page-hdr-right">
            <div class="page-hdr-desktop">
                <div class="page-menu menu-dropdown-wrapper menu-user">
                    <a class="user-link">
                        <span class="tbl-cell user-name pr-3" style="color: aliceblue;font-size:initial;">Account</span>
