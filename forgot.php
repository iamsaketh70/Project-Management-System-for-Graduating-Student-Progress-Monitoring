...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($connection,"select email from tbl_faculty where email='$email'");
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="C:\xampp\htdocs\RSE\passwordreset.php ?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
